      ...
      <el-form :model="service" ref="service" :rules="rulesService" label-position="top">
        <el-tabs v-model="serviceTabs">
                    ...
                    <el-collapse-transition>
                      <div
                        ...
                        <el-form :model="extra" ref="extra" :rules="rulesExtra" label-position="top">
                          ...
                          <!-- Aggregated Price -->
                          <div class="am-setting-box am-switch-box" v-if="service.maxCapacity > 1 && extra.aggregatedPrice !== null">
                            <el-row type="flex" align="middle" :gutter="24">
                              <el-col :span="19">
                                {{ $root.labels.aggregated_price }}
                                <el-tooltip placement="top">
          ...
          <el-tab-pane :label="$root.labels.settings" name="settings">
            ...
            <bookable-payment
                :settings="settings"
                :bookablePayments="service.settings.payments"
            >
            </bookable-payment>
          </el-tab-pane>
...
<script>
  ...
  import BookablePayment from '../parts/BookablePayment.vue'

  export default {
    mixins: [imageMixin, dateMixin, durationMixin, priceMixin, notifyMixin, helperMixin],
